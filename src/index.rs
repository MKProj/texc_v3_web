...
pub const INDEX_DM: &str = r#"<!DOCTYPE html>
<html>
...
pub const INDEX_LM: &str = r#"<!DOCTYPE html>
<html>
<title>TexCreate v3 Web</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<style>
body, h1,h2,h3,h4,h5,h6 {font-family: "Montserrat", sans-serif; color: #3c675e;}
.w3-row-padding img {margin-bottom: 12px}
/* Set the width of the sidebar to 120px */
.w3-sidebar {width: 120px;background: #222;}
/* Add a left margin to the "page content" that matches the width of the sidebar (120px) */
...
<body style="background-color: #e2ecec;">
<!-- Page Content -->
<div class="w3-padding-large" id="main">
    <!-- Header/Home -->
    ...
    <!-- About Section -->
    <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
        <h2>BUILD A LaTeX PROJECT</h2>
        <hr style="width:200px" class="w3-opacity">
            <div class="w3-container w3-center">
<form method="post" action="/">
    <label for="proj_name">Project Name</label><br>
    <input class="lm w3-button" type="text" name="proj_name" id="proj_name" placeholder="Project Name"><br>
    <label for="template">Template</label><br>
    <select class="lm w3-button" type="text" name="template" id="template" placeholder="Template">
    {templates}
    </select>
    <br>
    <label for="author">Author</label><br>
    <input  class="lm w3-button" type="text" name="author" id="author" placeholder="Author"><br>
    <label for="date">Date</label><br>
    <input class="lm w3-button" type="text" name="date" id="date" placeholder="Date"><br>
    <label for="title">Title</label><br>
    <input class="lm w3-button" type="text" name="title" id="title" placeholder="Title"><br>
    <label for="fontsize">Font Size</label><br>
    <input class="lm w3-button" type="text" name="fontsize" id="fontsize" placeholder="Font Size"><br>
    <label for="papersize">Paper Size</label><br>
    <input class="lm w3-button" type="text" name="papersize" id="papersize" placeholder="Paper Size"><br>
    <label for="doc_class">Document Class</label><br>
    <input class="lm w3-button" type="text" name="doc_class" id="doc_class" placeholder="Document Class"><br>
    <br>
    <input class="w3-btn lm" type="submit" value="Submit">
</form>
</div>
    </div>
    <!-- Footer -->
